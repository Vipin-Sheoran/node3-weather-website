...
if(error){
    ...
    callback(undefined,body.daily[0].weather[0].description+' throughout the day. Current temperature is '+body.current.temp+' degrees. Wind speed is '+body.current.wind_speed+' m/s.')
}
})
}
